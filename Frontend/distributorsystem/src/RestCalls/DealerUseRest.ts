...
export const useRestDealer = (): [
    ...
    function newDealer(dealer: IDealer, dealerDocuments: IDealerDocument[]) {
        ...
        axios.post('https://distromentor.onrender.com/dealer/registerDealer', formData, {
            headers: {
    ...
    function confirmDealer(dealerID: string, creditLimit: number) {
        ...
        axios.put(`https://distromentor.onrender.com/dealer/confirmDealer/${dealerID}`, null, {
            params: {
    ...
    function markDealerAsPending(dealerID: string, reason: string) {
        ...
        axios.put(`https://distromentor.onrender.com/dealer/updateDealerPending/${dealerID}`, null, {
            params: {
                remarks: reason,
            }
        })
    ...
    function declineDealer(dealerID: string, reason: string, dateArchived: string) {
        ...
        axios.put(`https://distromentor.onrender.com/dealer/updateDealerDecline/${dealerID}`, null, {
            params: {
                remarks: reason,
    ...
    function updateDealerCreditLimit(dealerID: string, creditLimit: number) {
        axios.put(`https://distromentor.onrender.com/dealer/updateCreditLimit/${dealerID}`, null, {
            params: {
                creditlimit: creditLimit,
            }
        })
    ...
    function getDealerByID(dealerID: string) {
        ...
        axios.get(`https://distromentor.onrender.com/dealer/getDealerByID/${dealerID}`)
            .then((response) => {
    ...
    function fetchTotalProductSubtotal(dealerID: string, creditLimit: number) {
        axios.get(`https://distromentor.onrender.com/allProductSubtotals/getByDealerId/${dealerID}`)
            .then((response) => {
    ...
    function getDealerByDistributor(dealerID: String, distributorid: string) {
        axios.get(`https://distromentor.onrender.com/dealer/getDealerByDistributor/${dealerID}/${distributorid}`)
            .then((response) => {
                if (response.data !== '') {
    ...
    function getRemainingDealerCredit(dealerID: string) {
        ...
        axios.get(`https://distromentor.onrender.com/dealer/getTotalOrderAmountByDealerID/${dealerID}`)
            .then((response) => {
