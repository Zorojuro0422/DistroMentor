        ...
        <div>
            <Drawer open={true} variant="permanent">
                <ColorBox onMouseLeave={handleCloseDropDownList}>
                    <AppNameTypography>
                        <img src={logo7} onClick={homeHandler} style={{ cursor: 'pointer', height: '230px', width: '410px' }} />
                    </AppNameTypography>
                    <List>
                        {/** Dealer Order Form */}
                        ...
                        <Link to="/customerRegistration">
                            <StyledButton onClick={() => handleButtonClick(2)} selected={selectedButton === 2} focusRipple>
                                <StyledListItem>
                                    <ListItemIcon sx={{ left: 200 }}>
                                    ...
                                    <StyledText selected={selectedButton === 2} primary="Customer Registration" />
                                </StyledListItem>
                            </StyledButton>
                        </Link>
                        {/** Dealer Products */}
                        ...
                        <Link to="/customerlist">
                            <StyledButton onClick={() => handleButtonClick(4)} selected={selectedButton === 4} focusRipple>
                                <StyledListItem>
                                    ...
                                    <StyledText selected={selectedButton === 4} primary="Customer" />
                                </StyledListItem>
                            </StyledButton>
                        </Link>
                         {/** Customer Order Form */}
                        <Link to="/customerOrderForm">
                            <StyledButton onClick={() => handleButtonClick(5)} selected={selectedButton === 5} focusRipple>
                                <StyledListItem>
                                    ...
                                    <StyledText selected={selectedButton === 5} primary="Customer Order Form" />
                                </StyledListItem>
                            </StyledButton>
                        </Link>
