...
export default function ContentDealer() {
    ...
    const getNavNamePage=()=>{
      ...
      const navPageNameMapping: Record<string,string>={
          ...
          [`/customerTransaction/${objectId}`] : 'Payment Transaction Details',
          [`/customerOrderTransaction/${objectId}`] : 'Customer Order Transaction Details',
          ...
          [`/orderTransactionDetails/${objectId}`] : 'Order and Payment Transaction Details',
  ...
  const getNavContentPage=()=>{
    ...
    const navPageContentMapping: Record<string,string>={
        ...
        '/history': 'Viewing of all orders including customer orders',
        '/customercollection': 'Collecting money to customer',
        '/customerorder': 'View customer order',
        ...
        [`/customerTransaction/${objectId}`] : `View customer's payment transaction details - Order Transaction ID:  ${objectId}`,
        [`/customerOrderTransaction/${objectId}`] : `View customer's order transaction details - Order Transaction ID:  ${objectId}`,
