...
export function CustomerTransaction() {
  ...
  const handlePrint = () => {
    ...
    const handleDepositSubmit = () => {
      ...
      // Build the payload with the updated status
      const payload = {
      ...
      axios
        .put(`https://distromentor.onrender.com/customerOrder/${objectId}`, payload)
        .then(() => {
                     ...
                     <div className="no-print" style={{ zIndex: 5, position: 'relative' }}>
                       <Grid
                         ...
                         style={{
                           ...
                           top: 80, // Distance from the top of the page
                       ...
                       >
                         ...
                         {/* Conditionally render TextField and Button if status is not Closed */}
                         {order?.status !== "Closed" && (
                           <>
                             <Grid item>
                               <TextField
                             ...
                             <Grid item>
                               <Button variant="contained" onClick={handleDepositSubmit}>
                                 Submit
                               </Button>
                             </Grid>
                           </>
