...
const OrderingPage: React.FC = () => {
  ...
  const fetchProducts = async () => {
    try {
      ...
      const response = await axios.get(`https://distromentor.onrender.com/api/dealer-products/dealer/${dealerID}`);
  ...
  const fetchCustomers = async () => {
    try {
      const dealerID = userFromStorage.dealer.dealerid;
      const response = await axios.get(`https://distromentor.onrender.com/customer/dealer/${dealerID}`);
 ...
 const handleSaveOrder = async () => {
     ...
     try {
         const response = await axios.post('https://distromentor.onrender.com/customerOrder/newOrder', order);
             ...
             cart.map(async (orderedProduct) => {
                 try {
                     ...
                     const dealerProductsResponse = await axios.get(
                         `https://distromentor.onrender.com/api/dealer-products/dealer/${dealerID}`
                     );
                     ...
                     if (existingDealerProduct) {
                         ...
                         await axios.put(`https://distromentor.onrender.com/api/dealer-products/${existingDealerProduct.dealerproductid}`, {
