      ...
      try {
        ...
        const updateProductQuantities = orderedProducts.map(async (orderedProduct) => {
          try {
            ...
            const response = await axios.get<IProduct>(`http://distromentor.onrender.com/product/getAllProducts/${product.productid}`);
            ...
            await axios.put(`http://distromentor.onrender.com/product/${product.productid}`, {
              name: product.name,
            ...
            const dealerProductsResponse = await axios.get<DealerProduct[]>(
              `http://distromentor.onrender.com/api/dealer-products/dealer/${order?.dealer.dealerid}`
            );
            ...
            if (existingDealerProduct) {
              ...
              await axios.put(
                `http://distromentor.onrender.com/api/dealer-products/${existingDealerProduct.dealerproductid}`,
                {
              ...
              await axios.post('http://distromentor.onrender.com/api/dealer-products', dealerProductPayload);
            }
          } catch (error) {
        ...
        await axios.post('http://distromentor.onrender.com/allProductSubtotals/saveOrUpdate', {
