...
export default function SalesAndCashierDashboard() {
    ...
    const getAllUnconfirmedOrders = () => {
        axios.get(`https://distromentor.onrender.com/order/getAllUnconfirmedOrdersByDistributorID/${userFromStorage.salesAssociateAndCashier.distributor.distributorid}`)
            .then((response) => {
    ...
    const getAllUnconfirmedCollectionPaymentReceipts = () => {
        axios.get(`https://distromentor.onrender.com/paymentreceipt/collectionpaymentreceipt/getAllUnconfirmedCollectionPaymentReceiptsByDistributorID/${userFromStorage.salesAssociateAndCashier.distributor.distributorid}`)
            .then((response) => {
