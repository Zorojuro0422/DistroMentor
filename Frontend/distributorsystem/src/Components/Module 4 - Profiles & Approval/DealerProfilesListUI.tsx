...
export default function DealerProfileListUI() {
    ...
    function getAllDealers() {
        axios.get<IDealer[]>(`http://distromentor.onrender.com/dealer/getAllDealersByDistributorID/${userFromStorage.distributor.distributorid}`)
            .then((response) => {
    ...
    function getAllArchivedDealers() {
        axios.get<IArchivedDealer[]>(`http://distromentor.onrender.com/archived/getAllArchivedDealersByDistributorID/${userFromStorage.distributor.distributorid}`)
            .then((response) => {
