...
const UpdateCustomer: React.FC = () => {
  ...
  const fetchCustomer = async () => {
    try {
      const response = await axios.get(`http://distromentor.onrender.com/customer/${objectId}`);
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(`http://distromentor.onrender.com/customer/${objectId}`, customer);
